...
testing(){
    ...
    CUDA_VISIBLE_DEVICES=$GPU_ID  numactl --cpunodebind=$CPU_ID --localalloc ./guetzli --quality 90 --cuda $input_file_or_directory $output_file_or_directory #> /dev/null 2>&1
